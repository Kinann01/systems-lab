...
/**
 * TODO: Atomically RW ptrs
 */
err_ring_buffer_t enqueue_rb(void* item, ring_buffer_t* rb) {

	size_t enq_ptr = rb->enq_ptr;
	size_t deq_ptr = rb->deq_ptr;
...
err_ring_buffer_t dequeue_rb(void** item, ring_buffer_t* rb) {
